...
import { Shield, LogOut, Settings, UserPlus, User, ChevronDown } from 'lucide-react';
...
export function Navbar() {
  ...
  return (
    <nav className="border-b border-zinc-800 bg-black/50 backdrop-blur-md sticky top-0 z-50 h-16">
      <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between font-sans text-zinc-400">
